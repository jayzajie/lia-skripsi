...
@section('title', 'Tahun Ajaran - Super Admin')
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        {{-- <a href="{{ route('superadmin.academic-years.create') }}" class="btn btn-primary">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    @if(!$year->is_active)
                                                        <form action="{{ route('superadmin.academic-years.set-active', $year) }}" method="POST">
                                                            @csrf
                                                            @method('PUT')
                                                    ...
                                                    @endif
                                                    <a href="{{ route('superadmin.academic-years.edit', $year) }}" class="btn btn-sm btn-primary">
                                                        <i class="ti ti-edit"></i> Edit
                                                    </a>
                                                    @if(!$year->is_active)
                                                        <form action="{{ route('superadmin.academic-years.destroy', $year) }}" method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="submit" class="btn btn-sm btn-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus tahun ajaran ini?')">
